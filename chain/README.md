...
* *scriptSig*: a script satisfying the conditions set on the UTXO (BIP16)
* *scriptWitness*: a script satisfying the conditions set on the UTXO (BIP141)
...
**Preface**: here I will try to give the minimal context surrounding segwit as is necessary to understand why witnesses exist in terms of blocks, block headers, and transactions. I will go into more detail of how these are implemented in regards to the different scripts in the **script** crate.
...
* an equivalence method to compare against other indexed structures (specifically the PartialEq trait)
* a deserialize method

**Still trying to figure out the purpose of these indexed structures.** I have done some preliminary research -- nevertheless, the significance will likely be realized after the analysis of more crates.
